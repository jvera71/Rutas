...
namespace RutasBackend.Components.Pages
{
    public partial class ApplicationUsers
    {
        ...
        protected IEnumerable<RutasBackend.Models.ApplicationUser> users;
        protected RadzenDataGrid<RutasBackend.Models.ApplicationUser> grid0;
        ...
        protected async Task RowSelect(RutasBackend.Models.ApplicationUser user)
        {
        ...
        protected async Task DeleteClick(RutasBackend.Models.ApplicationUser user)
        {
            try
            {
