...
{
    options.Name = "RutasBackendTheme";
...
builder.Services.AddHttpClient("RutasBackend").ConfigurePrimaryHttpMessageHandler(() => new HttpClientHandler { UseCookies = false }).AddHeaderPropagation(o => o.Headers.Add("Cookie"));
